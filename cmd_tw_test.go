...
func TestTwHelpLong(t *testing.T) {
	cmd := exec.Command("./gobox", "tw", "--help")
	output, err := cmd.Output()
	if err != nil {
...
func TestTwInvalidPort(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "tw", "-p", "invalid")
	err := cmd.Run()
...
func TestTwUnknownOption(t *testing.T) {
	cmd := exec.Command("./gobox", "tw", "--unknown")
...
func TestTwInvalidPortFormat(t *testing.T) {
	// Test with a port that exceeds valid range
	cmd := exec.Command("./gobox", "tw", "-p", "99999")
	err := cmd.Run()
	// Should handle invalid port gracefully (parse to 99999 which is invalid)
	// or fail
	t.Logf("Command result for port 99999: %v", err)
}
...
func TestTwIntegrationBenchModeHelp(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "tw", "--bench", "-h")
	output, err := cmd.Output()
	if err != nil {
...
func TestTwIntegrationPortOption(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "tw", "-p", "8888", "-h")
	output, err := cmd.Output()
	if err != nil {
...
func TestTwIntegrationDirOption(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "tw", "-d", "/tmp", "-h")
	output, err := cmd.Output()
	if err != nil {
...
func TestTwIntegrationCombinedOptions(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "tw", "--bench", "-p", "9999", "-d", "/tmp", "-r", "-h")
	output, err := cmd.Output()
	if err != nil {
...
func TestTwIntegrationEqualsSyntax(t *testing.T) {
	// Test --port= syntax
	cmd := exec.Command("./gobox", "tw", "--port=8888", "-h")
	output, err := cmd.Output()
	if err != nil {
...
func TestTwIntegrationDirEqualsSyntax(t *testing.T) {
	// Test --dir= syntax
	cmd := exec.Command("./gobox", "tw", "--dir=/var/www", "-h")
	output, err := cmd.Output()
	if err != nil {
