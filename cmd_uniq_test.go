...
func TestUniqBasic(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_basic.txt")
...
func TestUniqCount(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-c", "test_uniq_count.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqRepeated(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-d", "test_uniq_dup.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqUnique(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-u", "test_uniq_uniq.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqEmptyFile(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_empty.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSingleLine(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_single.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqAllIdentical(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_all_same.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqAllUnique(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_all_unique.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqAlternating(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_alternating.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqCountWithSingleLines(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-c", "test_uniq_count_single.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqCountWithAllIdentical(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-c", "test_uniq_count_all_same.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqIgnoreCase(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-i", "test_uniq_ignore_case.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqIgnoreCaseCount(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-c", "-i", "test_uniq_ignore_case_count.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqIgnoreCaseRepeated(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-d", "-i", "test_uniq_ignore_case_dup.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqIgnoreCaseUnique(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-u", "-i", "test_uniq_ignore_case_uniq.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqCheckChars(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-w", "4", "test_uniq_check_chars.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqCheckCharsCount(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-c", "-w", "5", "test_uniq_check_chars_count.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqCheckCharsRepeated(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-d", "-w", "3", "test_uniq_check_chars_dup.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqCheckCharsZero(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-w", "0", "test_uniq_check_chars_zero.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqCheckCharsExact(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-w", "3", "test_uniq_check_chars_exact.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSkipFields(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "1", "test_uniq_skip_fields.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSkipFieldsCount(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-c", "-f", "1", "test_uniq_skip_fields_count.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSkipFieldsRepeated(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-d", "-f", "1", "test_uniq_skip_fields_dup.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSkipFieldsMultiple(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "2", "test_uniq_skip_fields_multi.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSkipFieldsZero(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "0", "test_uniq_skip_fields_zero.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSkipFieldsMoreThanLineHas(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "5", "test_uniq_skip_fields_over.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqIgnoreCaseAndCheckChars(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-i", "-w", "3", "test_uniq_combo1.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSkipFieldsAndIgnoreCase(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-u", "-f", "1", "-i", "test_uniq_combo2.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqSkipFieldsAndCheckChars(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "1", "-w", "3", "test_uniq_combo3.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqCountWithRepeatedAndUnique(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-c", "-d", "test_uniq_combo4.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqAllFlagsCombined(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "1", "-i", "-w", "3", "test_uniq_combo_all.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqStdinCheckChars(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-w", "4")
	cmd.Stdin = strings.NewReader("abcdef\nghijkl\nabcxyz\n")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqStdinSkipFields(t *testing.T) {
	cmd := exec.Command("./gobox", "uniq", "-f", "1")
	cmd.Stdin = strings.NewReader("id1 value1\nid1 value2\nid2 value3\n")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqNonexistentFile(t *testing.T) {
	cmd := exec.Command("./gobox", "uniq", "nonexistent_file_12345.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqInvalidCheckChars(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-w", "abc", "test_uniq_invalid_chars.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqInvalidSkipFields(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "xyz", "test_uniq_invalid_fields.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqNegativeCheckChars(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-w", "-1", "test_uniq_neg_chars.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqNegativeSkipFields(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "-5", "test_uniq_neg_fields.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqUnknownOption(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-z", "test_uniq_unknown.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqMissingCheckCharsArg(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-w", "test_uniq_missing_chars.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqMissingSkipFieldsArg(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-f", "test_uniq_missing_fields.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqMultipleFiles(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_multi1.txt", "test_uniq_multi2.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqMultipleFilesCount(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "-c", "test_uniq_multi_count1.txt", "test_uniq_multi_count2.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqMultipleFilesOneMissing(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_multi_exists.txt", "nonexistent_file.txt")
	_, err := cmd.Output()
	if err == nil {
...
func TestUniqHelp(t *testing.T) {
	cmd := exec.Command("./gobox", "uniq", "-h")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq -h command failed: %v", err)
	}
...
func TestUniqHelpLong(t *testing.T) {
	cmd := exec.Command("./gobox", "uniq", "--help")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq --help command failed: %v", err)
	}
...
func TestUniqLongFlags(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "--count", "test_uniq_long1.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq --count failed: %v", err)
	}
...
func TestUniqLongFlagRepeated(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "--repeated", "test_uniq_long2.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq --repeated failed: %v", err)
	}
...
func TestUniqLongFlagUnique(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "--unique", "test_uniq_long3.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq --unique failed: %v", err)
	}
...
func TestUniqLongFlagIgnoreCase(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "--ignore-case", "test_uniq_long4.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq --ignore-case failed: %v", err)
	}
...
func TestUniqLongFlagCheckChars(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "--check-chars=3", "test_uniq_long5.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq --check-chars failed: %v", err)
	}
...
func TestUniqLongFlagSkipFields(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "--skip-fields=1", "test_uniq_long6.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq --skip-fields failed: %v", err)
	}
...
func TestUniqSpecialChars(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_special.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
...
func TestUniqWhitespace(t *testing.T) {
	...
	cmd := exec.Command("./gobox", "uniq", "test_uniq_whitespace.txt")
	output, err := cmd.Output()
	if err != nil {
		t.Fatalf("uniq command failed: %v", err)
	}
